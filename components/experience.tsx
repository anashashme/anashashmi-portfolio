...
const experiences = [
  {
    title: "Cybersecurity Support Engineer",
    company: "Trillium Information Security Systems",
    location: "Rawalpindi, Punjab, Pakistan",
    period: "May 2025 - Present",
    type: "Hybrid",
    description: [
      "Providing technical support for IBM QRadar and Wazuh, handling deployments, configurations, and performance tuning.",
      "Investigating and resolving SIEM-related issues, including log source onboarding, parsing errors, and alert misfires.",
      "Assisting clients and internal teams with threat detection use cases, custom rule creation, and platform optimization."
    ],
  },
  {
